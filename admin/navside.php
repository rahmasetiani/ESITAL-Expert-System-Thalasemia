...
<div id="content" style="margin-top: 56px;">
   ...
   data-idhasil='<?= $result[idhasil]; ?>' 
   data-diagnosa='<?= htmlspecialchars($result[hasil_diagnosa]); ?>' 
   data-similarity='<?= htmlspecialchars($result[hasil_similarity]); ?>'>
    ...
    <div class="modal-content">
      ...
      <form method="POST" action="update_hasil.php">
        <div class="modal-body">
          ...
          <!-- Pilihan Diagnosa dan Similarity -->
          <div class="mb-3">
            <label for="editDiagnosa" class="form-label">Pilih Hasil Diagnosa</label>
            <select class="form-select" name="keseluruhan_diagnosa" id="editDiagnosa">
              <!-- Opsi akan ditambahkan menggunakan JavaScript -->
            </select>
          </div>

          <div class="mb-3">
            <label for="editSimilarity" class="form-label">Pilih Similarity</label>
            <select class="form-select" name="keseluruhan_similarity" id="editSimilarity">
              <!-- Opsi akan ditambahkan menggunakan JavaScript -->
            </select>
          </div>
        </div>
